...
// Footer component with navigation and copyright
    ...
    <footer className="bg-gray-50 py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">Next.js</h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com" className="text-gray-400 hover:text-primary">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/examples" className="text-gray-600 hover:text-primary">
                  Examples
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-gray-500 text-center">
            &copy; {new Date().getFullYear()} Next.js. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
